...
public final class IKSegmenter {
	...
	public synchronized Lexeme next()throws IOException{
		...
		// 转拼音
//		if (l != null && l.getLexemeType() % 4 == 0 && l.getLexemeType() != 8) {
//			String pinyin = PinyinHelper.convertToPinyinString(l.getLexemeText(),
//					"", PinyinFormat.WITHOUT_TONE);
//			int chineseLength = l.getLength();
//			String chinese = l.getLexemeText();
...
//			l.setLength(pinyin.length() + chineseLength + 1);
//			l.setLexemeText(chinese + " " + pinyin);
//		}
